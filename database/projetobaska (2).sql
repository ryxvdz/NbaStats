...
--
-- Host: 127.0.0.1
-- Tempo de geração: 06/06/2025 às 22:14
...
CREATE TABLE `jogadores` (
  ...
  `TÍTULOS_COLETIVOS_NBAFINALS` text DEFAULT NULL,
  `TÍTULOS_INDIVIDUAIS` text DEFAULT NULL,
...
INSERT INTO `jogadores` (`ID_JOGADORES`, `NOME_DOS_JOGADORES`, `TÍTULOS_COLETIVOS_NBAFINALS`, `TÍTULOS_INDIVIDUAIS`, `SOBRENOME`, `DATANASCIMENTO`, `ALTURA`, `PESO`, `POSICAO`) VALUES
(1, 'Raphael', NULL, NULL, 'Langer', '2006-08-26', 175.00, 71, 'Ala-Armador'),
(2, 'Raphael', NULL, NULL, 'Langer', '2006-08-26', 175.00, 71, 'Ala'),
(3, 'Augusto ', NULL, NULL, 'Deolindo', '2004-09-28', 185.00, 98, 'Ala');
...
--
ALTER TABLE `jogadores`
  MODIFY `ID_JOGADORES` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;
